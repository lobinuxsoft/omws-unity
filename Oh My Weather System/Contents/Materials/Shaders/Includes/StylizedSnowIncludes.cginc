...
#ifndef OMWS_SNOW_INCLUDED
#define OMWS_SNOW_INCLUDED
...
float3 BlendStylizedSnow(float4 i, float3 normal, float3 worldPos)
{
	...
	float4 lerpResult19_g1 = lerp((OMWS_SnowColor * tex2D(OMWS_SnowTexture, uv_SnowTexture)), i, ((pow((pow(ase_worldNormal.y, 7.0) * (simplePerlin2D7_g1 * (1.0 - voroi5_g1))), 0.5) * 1.0) > (1.0 - OMWS_SnowAmount) ? 0.0 : 1.0));
