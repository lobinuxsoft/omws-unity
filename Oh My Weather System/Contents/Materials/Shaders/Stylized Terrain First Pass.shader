Shader "Crying Onion/OMWS/Stylized Terrain First Pass"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _Normal2;
			sampler2D _Normal3;
			float OMWS_PuddleScale;
			float OMWS_WetnessAmount;
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_6_0_g106 = ( 1.0 / OMWS_SnowScale );
				...
				float4 lerpResult19_g106 = lerp( ( OMWS_SnowColor * tex2D( OMWS_SnowTexture, uvOMWS_SnowTexture ) ) , localClipHoles100_g107 , ( ( pow( ( pow( WorldNormal.y , 7.0 ) * ( simplePerlin2D7_g106 * ( 1.0 - voroi5_g106 ) ) ) , 0.5 ) * dotResult53_g107 ) > ( 1.0 - OMWS_SnowAmount ) ? 0.0 : 1.0 ));
				...
				float temp_output_5_0_g105 = ( 1.0 / OMWS_PuddleScale );
				...
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = ( ( WorldNormal.y * 2.0 * ( (1.0 + (voroi1_g105 - 0.0) * (0.0 - 1.0) / (0.4 - 0.0)) + (0.1 + (voroi8_g105 - 0.0) * (-0.3 - 0.1) / (0.21 - 0.0)) ) * (0.3 + (OMWS_WetnessAmount - 0.0) * (1.0 - 0.3) / (1.0 - 0.0)) ) > ( 1.0 - ( OMWS_WetnessAmount * dotResult216_g107 ) ) ? 1.0 : 0.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 lerpResult202_g107 = lerp( appendResult55_g107 , maskMetallic169_g107 , layerHasMask136_g107);
				float dotResult53_g107 = dot( SplatControl26_g107 , lerpResult202_g107 );
				float4 lerpResult19_g106 = lerp( ( OMWS_SnowColor * tex2D( OMWS_SnowTexture, uvOMWS_SnowTexture ) ) , localClipHoles100_g107 , ( ( pow( ( pow( ase_worldNormal.y , 7.0 ) * ( simplePerlin2D7_g106 * ( 1.0 - voroi5_g106 ) ) ) , 0.5 ) * dotResult53_g107 ) > ( 1.0 - OMWS_SnowAmount ) ? 0.0 : 1.0 ));
