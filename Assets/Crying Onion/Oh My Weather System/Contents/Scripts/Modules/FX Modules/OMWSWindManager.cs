...
namespace CryingOnion.OhMy.WeatherSystem.Module
{
    ...
    public class OMWSWindManagerDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            property.FindPropertyRelative("_OpenTab").boolValue = EditorGUI.BeginFoldoutHeaderGroup(tabPos, property.FindPropertyRelative("_OpenTab").boolValue, new GUIContent("    Wind FX", "Wind FX set the speed and amount of the OMWS windzone and shader-based wind."), EditorUtilities.FoldoutStyle());
