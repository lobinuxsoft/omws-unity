Shader "Crying Onion/OMWS/Stylized Clouds Painted"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult898 = lerp( _CloudTextureColor , OMWS_LightColor , float4( 0.5,0.5,0.5,0 ));
