...
#ifndef OMWS_PUDDLES_INCLUDED
#define OMWS_PUDDLES_INCLUDED
...
float BlendStylizedPuddles(float3 normal, float3 worldPos)
{
	...
	float temp_output_5_0_g2 = (1.0 / OMWS_PuddleScale);
	float time1_g2 = 0.0;
	...
	return ((ase_worldNormal.y * 2.0 * ((1.0 + (voroi1_g2 - 0.0) * (0.0 - 1.0) / (0.4 - 0.0)) + (0.1 + (voroi8_g2 - 0.0) * (-0.3 - 0.1) / (0.21 - 0.0))) * (0.3 + (OMWS_WetnessAmount - 0.0) * (1.0 - 0.3) / (1.0 - 0.0))) > (1.0 - (OMWS_WetnessAmount * 1.0)) ? 1.0 : 0.0);
